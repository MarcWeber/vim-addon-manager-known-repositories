...
let s:scm_plugin_sources['visdo'] = {'type': 'git', 'url': 'git://github.com/intuited/visdo.git' }
...
let s:scm_plugin_sources['spec2580'] = {'type': 'git', 'url': 'git://github.com/tomtom/spec_vim.git' }
...
let s:scm_plugin_sources['indentfolds'] = {'type': 'git', 'url': 'git://github.com/tomtom/indentfolds_vim.git' }
let s:scm_plugin_sources['tGpg'] = {'type': 'git', 'url': 'git://github.com/tomtom/tgpg_vim' }
let s:scm_plugin_sources['brep'] = {'type': 'git', 'url': 'git://github.com/tomtom/brep_vim.git' }
let s:scm_plugin_sources['stakeholders'] = {'type': 'git', 'url': 'git://github.com/tomtom/stakeholders_vim.git' }
let s:scm_plugin_sources['tAssert'] = {'type': 'git', 'url': 'git://github.com/tomtom/tassert_vim.git' }
